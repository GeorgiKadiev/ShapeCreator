...
{
    public partial class Square : Models.Quadrilaterals.Quadrilaterals
    {
        ...
        public override void Draw(Panel panel, int ratio, bool isSelected)
        {
            ...
            Point bottomLeft = new Point(X, (int)_sideA * ratio + Y);
            Point bottomRight = new Point((int)_sideA * ratio + X, (int)_sideA * ratio + Y);
